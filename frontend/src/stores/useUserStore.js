...
// import { PERMISSIONS } from "../../../backend/constants/permissions.js";
...
//           } else {
//             permissions = ADMIN_ROLE_PERMISSIONS[userData.adminType] || [];
//           }
//         }
...
//       if (!userData.permissions) {
//         // Calculate permissions if not already set by backend
//         let permissions = [];
//         if (userData.role === "admin" && userData.adminType) {
//           if (userData.adminType === "super_admin") {
//             permissions = Object.values(PERMISSIONS);
