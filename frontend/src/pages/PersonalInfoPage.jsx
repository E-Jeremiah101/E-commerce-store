...
// import { nigeriaLocations } from "../utils/nigeriaLocation.js";
...
//   const allStates = nigeriaLocations.states();
//   const [selectedState, setSelectedState] = useState("");
//   const [cities, setCities] = useState([]);
//   useEffect(() => {
//     if (selectedState) {
//       const stateCities = nigeriaLocations.lgas(selectedState)?.lgas || [];
...
//                         setUser({ ...user, addresses: updated });
//                       }}
//                       className="w-full px-3 py-3 rounded-md bg-gray-100 border border-gray-300 focus:outline-none"
//                     >
