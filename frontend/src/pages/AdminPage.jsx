...
//         </span> */}
//       </motion.div>
//       <div className="  bg-gradient-to-br from-white via-gray-100 to-gray-300 flex h-[100vh] w-full px-2 mx-auto   overflow-hidden -10">
//         <div className="w-1/6 bg-gray-100  flex-shrink-0">
...
//           <div className="flex justify-center mb-8 overflow-auto no-scroll ">
//             {tabs.map((tab) => (
//               <button
//                 key={tab.id}
//                 onClick={() => setActiveTab(tab.id)}
