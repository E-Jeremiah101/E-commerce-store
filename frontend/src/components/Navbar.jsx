...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800">
      {/* {user ? (
        <span className="bg-gray-700  text-white-700 py-1 px-4  rounded-b-full inline-block items-center transition duration-300 ease-in-out">
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {isAdmin && (
              <Link
                className="bg-emerald-700 text-white hover:bg-emerald-600 transition rounded-md px-3 py-1 font-medium duration-300 ease-in-out flex items-center"
                to={"/secret-dashboard"}
              >
            ...
            {user ? (
              ...
              <>
                <Link
                  to={"/signup"}
                  className="bg-emerald-600 hover:bg-gray-700 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out"
                >
