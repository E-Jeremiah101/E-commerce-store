...
const MiniCartWidget = () => {
  ...
  return (
    <div className="fixed z-50 bottom-6 right-6 md:bottom-8 md:right-8 bg-white/90 shadow-2xl rounded-2xl px-6 py-4 flex items-center gap-4 border border-blue-200 backdrop-blur-md animate-fade-in-up">
